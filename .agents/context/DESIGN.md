...
The shared footer stays in document flow on non-gameplay app screens and information pages. A full-width paper band gives its dark text a steady background without outlines or resting link underlines. Links use weight to distinguish them and underline on hover or keyboard focus. Buy me a coffee has its own row, followed by the author credit, Contact, help and legal links, asset credits, and the brief rights notice. Keep each label and credit readable and intact when wrapping. Mobile spacing keeps it above the fixed navigation. Live questions omit the footer.
