...
The shared footer stays in document flow on non-gameplay app screens and information pages. It has no background and uses compact spacing while keeping dark text legible over the landscape. Links use weight to distinguish them and underline on hover or keyboard focus. Buy me a coffee has its own row, followed by the author credit, Contact, help and legal links, compact asset credits, and the brief rights notice. Keep each label and credit readable and intact when wrapping. Mobile spacing keeps it above the fixed navigation. Live questions omit the footer.
