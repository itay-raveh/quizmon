...
The guest sign-in screen introduces account benefits as three compact bullet points. Email and code fields show validation errors directly below the field, with an error border and an accessible description. Keep the sign-in card short and omit a closing privacy paragraph.
