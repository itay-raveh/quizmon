...
The shared footer stays in document flow on non-gameplay app screens and information pages. It sits directly on the landscape without a panel or border. Buy me a coffee has its own row, followed by the author credit, Contact, help and legal links, asset credits, and the brief rights notice. Keep each label and credit readable and intact when wrapping. Mobile spacing keeps it above the fixed navigation. Live questions omit the footer.
