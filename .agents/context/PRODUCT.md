...
- Covers Pokémon from Generations I through IX with regional and mechanical forms represented separately. Each retained form is a separate partner choice, answer, history subject, discovery, and badge requirement. Generation selections refer to the form’s introduction; National Pokédex numbers identify its species. Every shipped form is eligible for a named Type check, including forms without sprites.
- Catalog generation groups Alcremie combinations, Unown symbols, Vivillon patterns and their pre-evolution entries, Furfrou trims, seasonal coats, flower and sea colors, cosmetic gender appearances, duplicate Mothim entries, Xerneas appearances, and Koraidon/Miraidon riding modes. Minior retains Meteor and Core entries. Alcremie, Floette, and Pyroar retain their distinct battle forms, including Eternal Flower Floette. Pikachu costumes and caps, Spiky-eared Pichu, Original Color Magearna, Dada Zarude, rare family/segment variants, authenticity variants, Totem variants, Resolute Keldeo, and Cramorant’s Gulping and Gorging states do not have separate entries. Unused Arceus-unknown is excluded. These rules apply equally to partners, questions, history, and completion requirements.
