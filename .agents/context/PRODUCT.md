...
- Ability effect questions use imported short descriptions for all abilities with usable text. Choices use the same battle generation and exclude duplicate or closely overlapping descriptions. Authored advanced scenarios remain available, with imported questions as the fallback. Full explanations are available in a collapsed disclosure after answering. Missing or placeholder descriptions are recorded as data gaps.
