...
Daily is fixed at Level 3 across all generations, with one attempt per local calendar date. Training settings do not change Daily. Existing attempts and results retain their original rules, and retired challenge links cannot start a replacement lineup. Daily difficulty progression is deferred. Training has one repeatable ten-question flow with difficulty, independent generation/form controls, and optional customization. New players start at Level 1 with Gen I; migrated preferences use Level 3 and retain their content selections. Results and bests retain their original configuration. No account is required.
