...
`mise run setup` also installs the Git hooks. Pre-commit checks formatting, lint, and secrets; pre-push runs the complete gate. Use conventional commit messages.
