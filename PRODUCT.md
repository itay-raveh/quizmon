...
- Treats the local Trainer Card as a first-class profile with an optional name and partner Pokémon, four accent colors, records, qualified specialties, and five evolving League stamps. Stamp tiers determine the trainer's rank and visible card finish.
