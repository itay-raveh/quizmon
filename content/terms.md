...
Quizmon is free to play without an account. Scores, badges, and ranks have no
monetary value. There are no purchases or prizes.

Progress is stored in your browser and can be lost if site data is cleared or
removed. We do not provide account-based backups. Daily reminders are optional
...
We provide this service **"as is"** and **"as available"**, without warranties
of any kind to the extent permitted by law. We do not guarantee that the service
...
losses arising from your use of Quizmon, including lost progress or inability
to use the game. Nothing in these terms excludes liability that cannot legally
...
The card animation uses [Sparkles](https://opengameart.org/content/sparkles),
...
We may change or discontinue the service and update these terms, providing
notice where required by law. You may stop using Quizmon at any time.

If a provision is unenforceable, the remaining provisions continue to apply.
For questions or complaints, contact <quizmon@raveh.dev>.

---

_Adapted from [Automattic's Terms of Service](https://github.com/Automattic/legalmattic/blob/master/Terms%20of%20Service/WordPress.com/EN-Terms-of-Service.md)
for Quizmon, licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)._
